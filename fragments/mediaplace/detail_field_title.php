...
<div class="mp3-edit-field mp3-edit-field-inline" data-field-key="__title">
    <label class="mp3-edit-label">Titel</label>
    ...
    <button type="button" class="mp3-field-save-btn" data-save-field="__title" style="display:none"><i class="fa-solid fa-floppy-disk"></i> Speichern</button>
</div>
