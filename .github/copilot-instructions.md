...
3. **Modularisieren** – neue, in sich geschlossene Fähigkeiten als eigene Dateien/Klassen (`lib/`, `lib/Widgets/`, `lib/yform/value/`), nicht alles in `mediaplace.js`/`boot.php` anhäufen.
